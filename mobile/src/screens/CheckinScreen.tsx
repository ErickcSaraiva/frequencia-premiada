...
import {
  ...
  Alert, Keyboard, ScrollView, SafeAreaView, Modal,
} from 'react-native'
  ...
  const executarRegistro = async (codigo: string, origem: 'NFC' | 'Código' = 'Código') => {
    ...
    try {
      ...
      setUltimoCheckin({
        ...
        aula: alunoResponse.data.turma?.nome || 'Física II',
        pontos: 10,
      })
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.successCard}>
          ...
          <View style={styles.successInfo}>
            <Text style={styles.studentName}>{ultimoCheckin.nome}</Text>
            <Text style={styles.successText}>⊙ Check-in Realizado</Text>
          </View>
          <View style={styles.pointsBlock}>
            <Text style={styles.points}>+{ultimoCheckin.pontos} pts</Text>
            <Text style={styles.classText}>Aula: {ultimoCheckin.aula}</Text>
          </View>
        </View>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('Presencas')}>
          <Text style={styles.navIcon}>▤</Text>
...
const styles = StyleSheet.create({
  ...
  ringOuter: {
    ...
    borderRadius: 246,
    borderWidth: 3,
    borderColor: 'rgba(173,198,255,0.13)',
  },
  ringInner: {
    position: 'absolute',
    width: 292,
    ...
    borderRadius: 146,
    borderWidth: 3,
    borderColor: 'rgba(173,198,255,0.34)',
  },
  nfcButton: {
    width: 244,
    height: 244,
  ...
  personBadge: {
    ...
    borderRadius: 36,
    borderWidth: 3,
    borderColor: 'rgba(173,198,255,0.32)',
